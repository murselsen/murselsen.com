...
const Contact = () => {
  ...
  const formSchema = Yup.object({
    ...
    email: Yup.string()
      .email("must be suitable for email format")
  ...
  const onSubmit = (data, event) => {
    window.open(
      "mailto:murselsen_35@hotmail.com?subject=Message from murselsen.com&body=" +
        formData["message"],
      "_blank"
    );
    ...
    <div className={Css.ContactPage}>
      ...
      <div className={Css.Content}>
        <div className={Css.FormArea}>
          ...
          >
            <Form
              action={"mailto:murselsen_35@hotmail.com"}
              method={"post"}
              className={Css.Form}
            >
              ...
              <div className={Css.FormGroup}>
                <label htmlFor={"inputEmail"} className={Css.FormLabel}>
                  _email:
                </label>
                <Field
                  type={"text"}
              ...
              <div className={Css.FormGroup}>
                <label htmlFor={"inputMessage"} className={Css.FormLabel}>
                  _message
                </label>
                <Field
                  name={"message"}
