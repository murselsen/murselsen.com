        ...
        <>
            <div className={HomeCss.content}>
                <div className={HomeCss.content__introduction}>
                    ...
                    <p className={HomeCss.mission}>Junior Full Stack Feveloper</p>
                </div>
                <div className="content__link">
                    ...
                    <ConstCodeText variable="Instagram" value="github.com/murselsen" type="link" link="https://www.instagram.com/35.mursel/" />
